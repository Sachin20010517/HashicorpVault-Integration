...
# Certificate is saved at: /etc/letsencrypt/live/sachinayeshmantha.live/fullchain.pem
# Key is saved at:         /etc/letsencrypt/live/sachinayeshmantha.live/privkey.pem
...
8
export VAULT_ADDR=https://kmsvault.sachinayeshmantha.live:8200
echo "export VAULT_ADDR=https://kmsvault.sachinayeshmantha.live:8200" >>~/.bashrc
